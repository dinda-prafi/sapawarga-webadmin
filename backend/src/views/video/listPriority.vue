<template>
  <div class="app-container" name="list-priority-Video">
    <el-row :gutter="20">
      <el-col :lg="24">
        <el-row style="margin: 10px 0px">
          <el-col :span="4" style="margin-left: 10px">
            <el-button type="primary" :disabled="isDisabled" @click="dialogTableVisible = true">
              Tambah Video Prioritas
            </el-button>
          </el-col>
        </el-row>
        <div class="editor-container">
          <dnd-list :list1="listPriority" list1-title="List Video Priority" />
        </div>
        <el-row>
          <el-col :span="2">
    ...
    async onSaveChange() {
      ...
      if (this.listPriority !== undefined) {
        this.listPriority.forEach((item, index) => {
          data.push({ 'video_id': item.id, 'seq': index + 1 })
        })
      }

      await priorityVideoUpdate(data)
